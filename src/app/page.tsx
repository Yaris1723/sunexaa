    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4 relative z-10 py-20">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/contact"
                className="bg-secondary text-secondary-foreground px-8 py-4 rounded-md font-bold text-lg hover:bg-secondary/90 transition-colors inline-flex items-center justify-center"
              >
                Request a Quote <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
              <Link
                href="/products"
                className="bg-white/10 backdrop-blur-sm border border-white/20 text-white px-8 py-4 rounded-md font-bold text-lg hover:bg-white/20 transition-colors inline-flex items-center justify-center"
              >
                View Catalog
              </Link>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-sm font-medium text-muted-foreground uppercase tracking-wide">Verified Vendors</div>
            </div>
            <div>
              <div className="text-3xl font-black text-primary mb-1">B2B</div>
              <div className="text-sm font-medium text-muted-foreground uppercase tracking-wide">Bulk Sourcing</div>
            </div>
            <div>
              <div className="text-3xl font-black text-primary mb-1">PAN-India</div>
              <div className="text-sm font-medium text-muted-foreground uppercase tracking-wide">Logistics Network</div>
            </div>
            <div>
              <div className="text-3xl font-black text-primary mb-1">ISO</div>
              <div className="text-sm font-medium text-muted-foreground uppercase tracking-wide">Quality Compliant</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-16 items-center">
            <div className="md:w-1/2">
              <span className="text-secondary font-bold uppercase tracking-widest text-sm mb-2 block">Our Value Proposition</span>
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">Why Partner with BABA SUNEXAA?</h2>
      ...
      <section className="py-16 bg-primary text-white text-center">
        <div className="container mx-auto px-4">
          ...
          <Link
            href="/contact"
            className="bg-secondary text-secondary-foreground px-8 py-3 rounded-full font-bold text-lg hover:bg-secondary/90 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all"
          >
            Contact Us
          </Link>
        </div>
